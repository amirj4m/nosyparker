...
export const TOOLS = [
  {
    ...
    description: [
      ...
      'held is left alone.',
      '',
      'Two limits, and neither is about length for its own sake. A fact longer than',
      'ten thousand characters is refused: that is a document, not a fact about a',
      'person. And text that repeats itself heavily — a log, a key dump, a pasted',
      'blob — is refused because it would make every later search of this store',
      'slow. Ordinary writing of any reasonable length is fine.',
      '',
...

  {
    ...
    description: [
      ...
      'a thousand characters. A search can also be refused for what it would cost:',
      'that means something stored is unusually repetitive, not that you asked',
      'wrongly, so narrow the search rather than repeating it.',
      '',
