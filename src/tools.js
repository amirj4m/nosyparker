...
export const TOOLS = [
...

  {
    ...
    description: [
      ...
      'a thousand characters, and a search that runs for more than ten seconds is',
      'stopped and answered with a sentence rather than part of a result — add a',
      'word that narrows it, since every word has to match.',
      '',
